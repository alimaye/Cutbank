function [level,bw] = thresh_tool_pan_zoom_elev(im,cmap,defaultLevel) %mainfunction
% thresh_tool_pan_zoom_elev.m: Tool for interactive selection of an image
% threshold value, applied to elevation data. This function is based on thresh_tool.m 1.6.0.0
